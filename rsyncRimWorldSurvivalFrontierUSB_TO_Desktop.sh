...
SOURCE_PATH_RAW="/media/${USER}/writable/Archivio/Programmazione/Modding"
DESTINATION_PATH_RAW="/home/${USER}/Documenti/Archivio/Programmazione/Modding"
...
if rsync "${PARAMETERS[@]}" "${SOURCE}" "${DESTINATION}"; then
    ...
    echo -e "\e[32m **************************************************************** \e[0m"
    echo -e "\e[32m ********** ${GAMENAME} > ${MODNAME} > USB To Desktop *********** \e[0m"
    echo -e "\e[32m **************************************************************** \e[0m"
else
    echo -e "\e[31m **************************************************************** \e[0m"
